...
func NewConfg() *Config {
	var (
		...
		modServerStats          = kingpin.Flag("mc.mod-server-stats", "Set server for additional stats (papermc, purpurmc, forge, neoforge, or fabric)").Envar("MC_MOD_SERVER_STATS").String()
	)
	return &Config{
